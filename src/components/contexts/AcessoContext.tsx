...
export const initialDataAcesso: StateAcesso = {
  ...
  idacesso: 0,
  idemp: 0, nmfant: '',
  iduser: 0, idnmuser: '', pswuser: '',
  pin: '',
  mail: '',
  fonec: '',
  net: 0,
  lvMod: 0,
  mdRecep: false,  nmRecep: 'Recepção',
  mdDesig: false,  nmDesig: 'Design',
  mdProdu: false,  nmProdu: 'Produção',
  mdAcaba: false,  nmAcaba: 'Acabamento',
  mdExped: false,  nmExped: 'Expedição',
  mdAdmin: false,  nmAdmin: 'Administração',
  mdMaster: false, nmMaster:'Master',
  mdConfig: false, nmConfig:'Config',
  pinAdm: '9999',
  page: '',
  logado: false,
  datetimei: '', datetimef: '', tempo: ''
};
...
export enum AcessoActions {
  ...
  setIdAces,
  setIdEmp, setNmFant,
  setIdUser, setIdNmUser, setPswUser,
  setPin,
  setMail,
  setFoneC,
  setNet,
  setLvMod,
  setMdRecep, setNmRecep,
  setMdDesig, setNmDesig,
  setMdProdu, setNmProdu,
  setMdAcaba, setNmAcaba,
  setMdExped, setNmExped,
  setMdAdmin, setNmAdmin,
  setMdMaster,setNmMaster,
  setMdConfig,setNmConfig,
  setPinAdm,
  setPage,
  setLogado,
  setDtIni, setDtFim, setTmp
}
