  ...
  return (
    <ThemeLogo>
      <L.Container>
        <L.ContainerMenuPage>
          <h2>Bem Vindo...</h2>
          <p>Abaixo você tera uma prévia da apresentação do Sistema.</p>
        </L.ContainerMenuPage>
        <L.DivisionHPanel />
        <h3>Sintese :</h3>
        <p>
        ...
        <p>
          ...
          imagem com a logomarca, ao clicar nela você estara fazendo um Reflesh
          no seu Brouser e reiniciando a Página que estamos.
        </p>
        <br />
        <p>
